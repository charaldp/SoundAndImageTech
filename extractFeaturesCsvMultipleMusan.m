...
%MusicFileList = dir('C:\Users\Hampo\Desktop\MusicSpeech\music_speech\music_speech\music_wav\*.wav');
%SpeechFileList = dir('C:\Users\Hampo\Desktop\MusicSpeech\music_speech\music_speech\speech_wav\*.wav');

MusicFileList = dir('MusicSpeech\musan\music_wav\*.wav');
SpeechFileList = dir('MusicSpeech\musan\speech_wav\*.wav');
...
fname=sprintf('Output/rawDataMusan.csv');
writetable(cell2table([attributes;num2cell(data)]),fname,'writevariablenames',0);
fname=sprintf('Output/noATTRSrawDataMusan.csv');
